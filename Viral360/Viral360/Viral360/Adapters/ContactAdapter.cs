...
namespace Uprise.Adapters
{
    public class ContactAdapter : IAdapter<ContactViewModel, Distributor>
    {
        ...
        public void AddContacts(HttpPostedFileBase contactsFile, Distributor distributor)
        {
            var currentRecord = "";
            try
            {
                ...
                Stream stream = contactsFile.InputStream;
        ...
        public void Dispose()
        {
            ...
            ((IDisposable)_contactRepository).Dispose();
        }
